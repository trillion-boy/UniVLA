#!/usr/bin/env python3
"""
latent_saccade_postnorm_eval.py

Evaluate LatentSaccadePostNormEmuVLAInference on SimplerEnv.
Identical to latent_saccade_eval.py but uses the post-RMSNorm hook variant.

Usage:
  conda run -n univla python latent_saccade_postnorm_eval.py \
    --emu-hub   <path> \
    --vq-hub    <path> \
    --fast-path <path> \
    --task widowx_put_eggplant_in_basket \
    --n-episodes 24 \
    --bg-weight 0.7 --place-src-weight 0.9 --fovea-weight 1.1
"""
